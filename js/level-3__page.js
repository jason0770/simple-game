...
window.onload = () => {
    ...
    addEventListenerToStartButton(startBtn, restartBtn, grid, items, score, backBtn, time, LEVEL_THREE_TIME_VAL);

    addEventListenerToRestartButton(restartBtn, grid, items, backBtn, time, LEVEL_THREE_TIME_VAL);
